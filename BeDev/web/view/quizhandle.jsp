        ...
        <div class="container-fluid">
            <div class="container mb-100">
                <c:if test="${answeredList != null}">
                    <c:choose>
                        <c:when test="${totalPoint * 10 >= quiz.getPassRate()}">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <h2 style="font-weight: 650">Congratulations! You passed!</h2>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-10">
                                                <h5>
                                                    <span style=" padding-right: 20px;">
                                                        ...
                                                        <span style="color: rgb(29, 124, 80);" > <fmt:formatNumber type = "number" value = "${totalPoint * 10}"/>%</span>
                                                    </span> 
                                                    <span>To pass <fmt:formatNumber type = "number" value = "${quiz.getPassRate()}"/>% or higher</span>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="container d-flex h-100">
                                            <div class="row justify-content-center align-self-center">
                                                <a href="Quiz?qid=${quiz.getQuizID()}" class="btn btn-primary btn-lg text-white">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style="background-color: #fadcdf; padding: 50px;">
                                <div class="row">
                                        ...
                                        <div class="row" style="margin-top: 20px;">
                                            ...
                                            <div class="col-md-10">
                                                <h5>
                                                    <span style=" padding-right: 20px;">
                                                        <span style="font-weight: 620;">Grade received</span> 
                                                        <span style="color: rgb(211, 0, 1);" > <fmt:formatNumber type = "number" value = "${totalPoint * 10}"/>%</span>
                                                    </span> 
                                                    <span>To pass <fmt:formatNumber type = "number" value = "${quiz.getPassRate()}"/>% or higher</span>
                                                </h5>
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="container d-flex h-100">
                                            <div class="row justify-content-center align-self-center">
                                                <a href="QuizHandle?qid=${quiz.getQuizID()}" class="btn btn-primary btn-lg text-white">Try again</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
